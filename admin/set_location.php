    ...
    <body>
        <nav class="navbar navbar-expand-sm navbar-dark" style="background-color: #4B7BEC">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="set_location.php">Update lokasi barang</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row justify-content-center">
            ...
            <?php else : ?>
                <?php $result = $mysqli->query("SELECT * FROM item") or die($mysqli->error); ?>
            <?php endif; ?>
                <div class="row justify-content-center">
                    <table class="table">
                        <thead>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="process.php?update=<?php echo $row['resi']; ?>" class ="btn btn-info" name="Update">Update Lokasi</a>
                            </tr>
                        <?php endwhile; ?>
            </div>
        </table>  
