    ...
    <body>
        ...
        <?php if (isset($_SESSION['message'])): ?>
            <div class="row justify-content-center">
                ...
                <?php $result = $mysqli->query("SELECT * FROM item LEFT JOIN mitra ON mitra_token = last_mitra WHERE resi = '$resi'") or die($mysqli->error); ?>
                <div class="row justify-content-center">
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><a href="track.php?track_resi=<?php echo $row['resi']; ?>" class ="btn btn-info">Track</a>
                            </tr>
                        <?php endwhile; ?>
                    </table>
                </div>
